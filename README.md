...
| Metric | v1.0.0-beta.2 |
|--------|--------|
| AI Cost* | $1.408 / 1K requests |
...
| Metric | v1.0.0-beta.2 |
|--------|--------|
| Indicative Latency | 10.88 s |
| Gmail API Critical I/O | 2.96 s |
| AI Critical I/O | 8.30 s |
| Total Critical I/O | 10.44 s |
| Orchestration Overhead | 0.43 s |
